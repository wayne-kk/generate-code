...
export interface IIPostsItemCategory {
  titleAttrLabel: string
  titleAttrLink: string
}
  ...
  posts = [
    {
      ...
      date: 'Mar 16, 2023',
      datetime: '2023-03-16',
      category: { titleAttrLabel: 'Branding',titleAttrLink:'/' },
      author: {
    ...
    },
    {
      ...
      date: 'Apr 10, 2023',
      datetime: '2023-04-10',
      category: { titleAttrLabel: 'Web Design',titleAttrLink:'/' },
      author: {
        name: 'Jordan Lee',
        role: 'Web Developer',
        imageUrl:
                  ...
                  <div>
                    <div className="flex items-center gap-x-4 text-xs">
                      ...
                      <EditableButton
                        ...
                        onClick={() => window.open(post.category.titleAttrLink, '_self')}
                      >
                        <EditableText propKey={`posts_${index}_category_titleAttrLabel`}>{post.category.titleAttrLabel}</EditableText>
                      </EditableButton>
                    </div>
