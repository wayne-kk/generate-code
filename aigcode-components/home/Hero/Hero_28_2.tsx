        ...
        <div className="w-full h-full grid grid-cols-1 items-center gap-16 md:grid-cols-2">
          <div className="w-full flex flex-col gap-16">
            ...
            <div className="flex items-center gap-6">
              {/* 优化后的一级按钮 */}
              <EditableButton className="BTN-PRIMARY group w-fit h-12 px-6 text-sm font-semibold uppercase text-white flex items-center gap-3 rounded-full bg-[#FF4418] hover:bg-[#ff5a34] hover:transition-all hover:duration-300 md:px-8 md:text-base md:h-14" href={primaryButton.textAttrLink}>
